...
//import static com.example.plathome.login.jwt.domain.AccessSecretKey.ACCESS_KEY_PATH;
...
//        //given
//        String secretKey = environment.getProperty(ACCESS_KEY_PATH);
...
//        String refreshToken = createRefreshToken(secretKey);
//        this.memberRepositorySetting();
//        this.refreshTokenIsInRedisSetting(refreshToken);
...
//    }
//
//    private void refreshTokenIsInRedisSetting(String refreshToken) {
//        given(refreshTokenRedisService.checkExistValue(any())).willReturn(true);
//        given(refreshTokenRedisService.getData(any())).willReturn(refreshToken);
//    }
//}